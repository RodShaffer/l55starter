...
@section('meta')
    <meta name="description" content="{{ config('site.title') }} index of all current Myrtle Beach area events.">
@endsection

@section('title')
    <title>{{ config('site.title') }} | All Current Myrtle Beach Area Events</title>
@endsection
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <h4 class="cgbg-heading">All Current Myrtle Beach Area Events</h4>

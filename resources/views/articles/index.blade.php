...
@section('meta')
    ...
    <meta name="description"
          content="{{ config('site.title') }} index of all Myrtle Beach area blog articles on topics such as local business, local events, golf, hotels, nightlife, restaurants, and more.">
@stop

@section('title')
    <title>{{ config('site.title') }} | All Blog Articles</title>
@stop
            ...
            <div class="col-12 col-md-8 col-lg-9">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <h4 class="cgbg-heading">All Blog Articles</h4>

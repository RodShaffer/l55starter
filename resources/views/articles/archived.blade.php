...
@if(isset($archive_date))
    <meta name="description" content="{{ config('site.title') }} index of all archived blog articles for {{ $archive_date }}.">
@else
    <meta name="description" content="{{ config('site.title') }} index of all archived blog articles.">
@endif
@stop

@section('title')
@if(isset($archive_date))
    <title>{{ config('site.title') }} | Archived Blog Articles {{ $archive_date }}</title>
@else
    <title>{{ config('site.title') }} | Archived Blog Articles</title>
@endif
@stop
...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="row mt-3">
            ...
            <div class="col-12 col-md-8 col-lg-9">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @if(isset($archive_date))
                            <h4 class="cgbg-heading">Archived Blog Articles {{ $archive_date }}</h4>
                        @else
                            <h4 class="cgbg-heading">Archived Blog Articles</h4>
                        @endif
            ...
            <div class="col-12 col-md-4 col-lg-3 cgbg-article-archive-container">

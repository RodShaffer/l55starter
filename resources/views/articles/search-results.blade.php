...
@section('meta')
    ...
    <meta name="description" content="{{ config('site.title') }} blog article search results.">
@stop

@section('title')
    <title>{{ config('site.title') }} | Blog Article Search Results</title>
@stop
            ...
            <div class="col-12 col-md-8 col-lg-9">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <h4 class="cgbg-heading">Blog Article Search Results</h4>
